...
export default function MatchReminderModal({ visible, onLogNow, onLater }: Props) {
  return (
    <Modal
      visible={visible}
      transparent
    ...
    >
      <View style={styles.overlay}>
        <View style={styles.card}>
          ...
          <Text style={styles.title}>How did the match go?</Text>
          <Text style={styles.body}>Don't forget to log your match result.</Text>
